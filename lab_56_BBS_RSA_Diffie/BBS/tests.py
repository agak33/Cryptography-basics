...
def frequency_test(bits: bin, lower_threshold: int, upper_threshold: int) -> bool:
    ...
    :param lower_threshold: lower threshold of interval (excluded lower_threshold number)
    :param upper_threshold: upper threshold of interval (excluded upper_threshold number)
    ...
    try:
        ...
        print(Fore.GREEN,
              ...
              round(result / len(bits) * 100, 3), '%, (', result, ')',
              Fore.RESET, sep='')
        return True
